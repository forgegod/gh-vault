...
| `test_vault_features.py` | Project-origin namespace normalization, mocked GitHub token metadata, encrypted environment archive/restore, remote Actions type checks, `act` exports, and workflow-wiring checks. |
